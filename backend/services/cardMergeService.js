...
//     role: (card.role || "").toLowerCase().trim(),
...
//   const noPersonA = !cardA.name && !cardA.emails.length && !cardA.phones.length;
//   const noPersonB = !cardB.name && !cardB.emails.length && !cardB.phones.length;
...
//         entity.emails = [...new Set([...entity.emails, ...card.emails])];
//         entity.phones = [...new Set([...entity.phones, ...card.phones])];
//         if (!entity.address && card.address) entity.address = card.address;
//         found = true;
//         break;
//       }
//     }
...
// module.exports = { mergeParsedCards };
